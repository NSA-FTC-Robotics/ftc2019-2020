...
public abstract class Move_Engine extends LinearOpMode {
    ...
    public DcMotor frontLeft,frontRight, backLeft, backRight, slide, actuator, extender, spinner;
    public Servo leftcollector, rightcollector, scorer;
    ...
    public void sleep(int time){
        ...
        {
            super.sleep(10);
            telemetry.addData("sleeping", count);
            telemetry.update();
        }
    }
    public void Standby(){
